...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <tbody class="table-border-bottom-0">
                            ...
                            @foreach ($user as $u)
                                <tr>
                                    ...
                                    <td><span
                                            class="badge bg-label-{{ $u->is_active == 0 ? 'danger' : 'success  ' }} me-1">{{ $u->is_active == 0 ? 'Nonaktif' : 'Aktif' }}</span>
                                    </td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" id="detail">
                                                <a class="dropdown-item" href="{{ url('/admin/users/' . $u->id) }}"><i
        ...
        <div class="d-flex justify-content-center py-3">
            <a class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#tambahUserModal">Tambah user
                baru</a>
        </div>
        <div div class="modal fade" id="tambahUserModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                        ...
                        <form id="formAccountSettings" method="POST" action="{{ url('/admin/users/store') }}">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="number" maxlength="2" id="rw"
                                        name="rw" placeholder="Nomor RW" />
                                </div>
                                <div class="mb-3">
